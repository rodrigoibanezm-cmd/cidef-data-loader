import { summarizeRelativeGap } from './shareGapStatistics.js';
...
export function buildCandidateResults(rows, candidates, commonRows) {
  return candidates.map((candidate) => {
    ...
    return {
      ...
      relative_gap_distribution: summarizeRelativeGap(specific, candidate.name),
      common_relative_gap_distribution: summarizeRelativeGap(commonRows, candidate.name),
    };
  });
}
