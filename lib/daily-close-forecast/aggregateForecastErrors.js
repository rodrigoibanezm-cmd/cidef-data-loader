...
function summarize(rows, grain, day) {
  ...
  return {
    ...
    median_absolute_percentage_error: percentile(ape, 0.5),
    p75_absolute_percentage_error: percentile(ape, 0.75),
    p90_absolute_percentage_error: percentile(ape, 0.9),
    mean_signed_percentage_error: mean(signed),
  };
}
