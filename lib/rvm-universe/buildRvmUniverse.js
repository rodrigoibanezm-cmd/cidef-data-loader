...
export function parseRvmUniverseInput(input = {}) {
  ...
  return { dateFrom, dateTo, organizationScope, filters, ...parseCutoff(input) };
}
...
export function assembleRvmUniverse(parsed, analyticalEvents) {
  ...
  return {
    ...
    lineage: {
      ...
      organization_authority: 'product_organization_membership + organizations_master',
      historical_fallback_authority: 'rvm_organization_historical_rule',
    },
  };
}
