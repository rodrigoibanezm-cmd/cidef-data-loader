import { selectProductSales } from './selectProductSales.js';

export function aggregateSelectedProductSales({ periodSales, targetSales }) {
...
export function aggregateProductSales(resolvedSales, input) {
  return aggregateSelectedProductSales(selectProductSales(resolvedSales, input));
}
