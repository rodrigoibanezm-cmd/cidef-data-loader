...
import { commercialMonthRange } from '../ventas/commercialMonth.js';

function bounds(startMonth, endMonth) {
  return {
    start: commercialMonthRange(startMonth).start.getTime(),
    end: commercialMonthRange(endMonth).end.getTime(),
  };
}
