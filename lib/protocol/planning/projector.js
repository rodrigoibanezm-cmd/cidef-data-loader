...
export function validateLongitudinalVentasProjection(request, { goal, capabilityContract, universeResolution }) {
  ...
  exact(capabilityContract.capability_id, 'LONGITUDINAL/VENTAS', 'UNSUPPORTED_PROJECTOR_CAPABILITY', '$.capability_id');
  ...
  invariant((goal.comparison ?? 'NONE') === 'NONE', 'PHYSICAL_COMPARISON_UNSUPPORTED', '$.goal.comparison');
