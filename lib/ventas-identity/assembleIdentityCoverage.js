...
export function assembleIdentityCoverage(row = {}) {
  ...
  return {
    rows_total: total,
    coverage: {
      store: { resolved: storeResolved, unresolved: storeUnresolved, ambiguous: storeAmbiguous, pct: pct(storeResolved, total) },
      seller: { resolved: sellerResolved, unresolved: sellerUnresolved, ambiguous: sellerAmbiguous, pct: pct(sellerResolved, total) },
      both: { resolved: bothResolved, pct: pct(bothResolved, total) },
    },
    distinct_keys: {
