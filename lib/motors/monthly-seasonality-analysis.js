...
import { monthlySeasonalitySql } from '../monthly-seasonality-sql.js';
import { monthlySeriesOutput, monthlySummaryOutput } from '../monthly-seasonality-output.js';
...
export async function execute(input = {}, sql) {
  ...
  return {
    ...
    summary_by_month_number: monthlySummaryOutput(series), series,
  };
}
