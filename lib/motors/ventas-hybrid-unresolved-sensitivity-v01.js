...
export function calculateVentasHybridUnresolvedSensitivity(rows, input = {}) {
  ...
  if (anyExtremeTieVins) warnings.push(`${anyExtremeTieVins} assignable VINs have multiple rows on FIRST and/or LAST extreme date; lowest id is used only as stable technical tie-break`);
