...
export async function ventasOrganizationalContextV01(input = {}) {
  ...
  return {
    ...
    policy: {
      ...
      seller_membership: 'resolved persona + VENDEDOR_TIENDA role and CIDEF assignment active on fecha_factura',
      historical_store: 'store observed on recognized event; never reassigned from current persona_sucursal',
