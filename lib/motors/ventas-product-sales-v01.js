...
export function calculateVentasProductSales(context, parsed) {
  ...
  return {
    ...
    policy: {
      ...
      unresolved_policy: 'kept explicit in coverage; never assigned by inference',
